<x-app-layout>
    <x-slot name="header">Add Other Expense</x-slot>
    ...
    <div class="max-w-xl mx-auto">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6"
            ...
            <h3 class="text-base font-semibold text-gray-800 mb-5">Expense Details</h3>
            ...
            <form action="{{ route('other-expenses.store') }}" method="POST" class="space-y-4">
                @csrf
                ...
                <div>
                    ...
                    <x-text-input id="amount" name="amount" type="number" step="0.01" min="0" class="mt-1" placeholder="0.00" required />
                    <x-input-error :messages="$errors->get('amount')" class="mt-1" />
                </div>

                <div>
                    <x-input-label for="expense_date" value="Date *" />
                    <x-text-input id="expense_date" name="expense_date" type="date" class="mt-1" :value="date('Y-m-d')" max="{{ date('Y-m-d') }}" x-bind:min="minDate" required />
                ...
                <div>
                    ...
                    <textarea id="notes" name="notes" rows="2" class="mt-1 w-full border-gray-300 rounded-lg shadow-sm focus:border-green-500 focus:ring-green-500" placeholder="Optional notes"></textarea>
                </div>
