...
<head>
    ...
    <title><?php echo e(config('app.name', 'FieldBook')); ?></title>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.application-logo','data' => ['class' => 'w-8 h-8 fill-current text-green-600 shrink-0']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-8 h-8 fill-current text-green-600 shrink-0']); ?>
...
<?php endif; ?>
            ...
            <nav class="flex-1 overflow-y-auto overflow-x-hidden px-3 py-4 space-y-1">
                ...
                <a href="<?php echo e(route('dashboard')); ?>" :title="collapsed ? 'Dashboard' : ''" :class="collapsed && 'md:justify-center'" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors duration-150 <?php echo e(request()->routeIs('dashboard') ? 'bg-green-50 text-green-700' : 'text-gray-600 hover:bg-gray-50'); ?>">
                ...
                <a href="<?php echo e(route('farm')); ?>" :title="collapsed ? 'My Farm' : ''" :class="collapsed && 'md:justify-center'" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors duration-150 <?php echo e(request()->routeIs('farm') || request()->routeIs('lands.*') ? 'bg-green-50 text-green-700' : 'text-gray-600 hover:bg-gray-50'); ?>">
                ...
                <a href="<?php echo e(route('labour-expenses.index')); ?>" :title="collapsed ? 'Labour Expenses' : ''" :class="collapsed && 'md:justify-center'" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors duration-150 <?php echo e(request()->routeIs('labour-expenses.*') ? 'bg-green-50 text-green-700' : 'text-gray-600 hover:bg-gray-50'); ?>">
                ...
                <a href="<?php echo e(route('fertilizer-applications.index')); ?>" :title="collapsed ? 'Fertilizer' : ''" :class="collapsed && 'md:justify-center'" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors duration-150 <?php echo e(request()->routeIs('fertilizer-applications.*') ? 'bg-green-50 text-green-700' : 'text-gray-600 hover:bg-gray-50'); ?>">
                ...
                <a href="<?php echo e(route('other-expenses.index')); ?>" :title="collapsed ? 'Other Expenses' : ''" :class="collapsed && 'md:justify-center'" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors duration-150 <?php echo e(request()->routeIs('other-expenses.*') ? 'bg-green-50 text-green-700' : 'text-gray-600 hover:bg-gray-50'); ?>">
                ...
                <a href="<?php echo e(route('crop-stocks.index')); ?>" :title="collapsed ? 'Crop Stocks' : ''" :class="collapsed && 'md:justify-center'" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors duration-150 <?php echo e(request()->routeIs('crop-stocks.*') ? 'bg-green-50 text-green-700' : 'text-gray-600 hover:bg-gray-50'); ?>">
                ...
                <a href="<?php echo e(route('crop-sales.index')); ?>" :title="collapsed ? 'Crop Sales' : ''" :class="collapsed && 'md:justify-center'" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors duration-150 <?php echo e(request()->routeIs('crop-sales.*') ? 'bg-green-50 text-green-700' : 'text-gray-600 hover:bg-gray-50'); ?>">
                ...
                <a href="<?php echo e(route('reports')); ?>" :title="collapsed ? 'Reports' : ''" :class="collapsed && 'md:justify-center'" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors duration-150 <?php echo e(request()->routeIs('reports') ? 'bg-green-50 text-green-700' : 'text-gray-600 hover:bg-gray-50'); ?>">
                ...
                <a href="<?php echo e(route('settings')); ?>" :title="collapsed ? 'Settings' : ''" :class="collapsed && 'md:justify-center'" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors duration-150 <?php echo e(request()->routeIs('settings') ? 'bg-green-50 text-green-700' : 'text-gray-600 hover:bg-gray-50'); ?>">
            ...
            <div class="border-t border-gray-100 p-4 shrink-0">
                ...
                <a href="<?php echo e(route('profile.edit')); ?>" :title="collapsed ? 'Profile' : ''" :class="collapsed && 'md:text-center'" class="block px-2 py-1.5 text-sm text-gray-600 hover:text-green-700 rounded-md">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 md:px-6 shrink-0">
                ...
                <?php if(isset($header)): ?>
                    <div class="text-lg font-semibold text-gray-800"><?php echo e($header); ?></div>
                <?php else: ?>
                    <div></div>
                <?php endif; ?>

                <div class="flex items-center gap-4">
                    <span class="text-sm text-gray-500 hidden sm:block"><?php echo e(now()->format('l, d M Y')); ?></span>
                </div>
            </header>
...
</html><?php /**PATH C:\laravel-projects\fieldbook\resources\views/layouts/app.blade.php ENDPATH**/ ?>